...
public class QuestionsAnswer extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        questxt = (TextView)findViewById(R.id.querry);
        anstxt = (TextView)findViewById(R.id.seeAnswer);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_questions_answer, menu);
        return true;
    }
